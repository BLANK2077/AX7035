...
HD_PWD='D:/demo_ax7035/demo_ax7035/sd_picture_hdmi/sd_picture_hdmi/sd_picture_hdmi.runs/afifo_32i_64o_256_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afifo_32i_64o_256.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afifo_32i_64o_256.tcl
