...
HD_PWD='D:/demo_ax7035/demo_ax7035/19_ad7606_hdmi_test/ad7606_hdmi_test/ad7606_hdmi_test.runs/dpram1024x8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dpram1024x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dpram1024x8.tcl
