...
HD_PWD='D:/demo_ax7035/demo_ax7035/smg_interface_demo/smg_interface_demo/smg_interface_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log smg_interface_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source smg_interface_demo.tcl
