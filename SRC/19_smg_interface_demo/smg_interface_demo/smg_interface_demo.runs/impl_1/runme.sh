...
HD_PWD='D:/demo_ax7035/demo_ax7035/smg_interface_demo/smg_interface_demo/smg_interface_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log smg_interface_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source smg_interface_demo.tcl -notrace
