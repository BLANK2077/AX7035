...
HD_PWD='D:/AX7035/24_video_ethernet/video_ethernet/video_ethernet.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_ethernet.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_ethernet.tcl
