...
HD_PWD='D:/demo_ax7035/demo_ax7035/22_USB_speed_test/usb_test/usb_test.runs/ft_buf_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ft_buf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ft_buf.tcl
