...
HD_PWD='D:/demo_ax7035/sd_card_audio/sd_card_audio.runs/afifo_8i_32o_1024_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afifo_8i_32o_1024.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afifo_8i_32o_1024.tcl
