...
HD_PWD='D:/AX7035/22_ad7606_ethernet/ad7606_ethernet/ad7606_ethernet.runs/rxd_clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rxd_clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rxd_clk.tcl
